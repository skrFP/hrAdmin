...
const CompanyCvController = props => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      cvList: (contact && contact.cvList) || 0,
    },
        ...
        <>
          <h5 className="font-size-14 mb-1">
            <Link
              to="#"
              className={
                company.isCvList === true ? "text-success" : "text-danger"
              }
            >
              {company.cvList}
            </Link>
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <MetaTags>
          <title>Компани анкет сан</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Компани" breadcrumbItem="Компани анкет сан эрх" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
                                            ...
                                            <Col xs={12}>
                                              ...
                                              <div className="mb-3">
                                                ...
                                                <Input
                                                  ...
                                                  onBlur={validation.handleBlur}
                                                  value={
                                                    validation.values.cvList ||
                                                    undefined
                                                  }
                                                  invalid={
                                                    validation.touched.cvList &&
                                                    validation.errors.cvList
                                                      ? true
                                                      : false
                                                  }
                                                />
...
export default withRouter(CompanyCvController)
