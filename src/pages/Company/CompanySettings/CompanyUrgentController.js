...
const CompanyUrgentController = props => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      urgent: (contact && contact.urgent) || 0,
    },
  ...
  const contactListColumns = [
    ...
    {
      dataField: "urgent",
      text: "Яааралтай компани тохиргоо",
      sort: true,
      // eslint-disable-next-line react/display-name
      formatter: (cellContent, company) => (
        <>
          <h5 className="font-size-14 mb-1">
            <Link
              to="#"
              className={
                company.isUrgent === true ? "text-success" : "text-danger"
              }
            >
              {company.urgent}
            </Link>
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <MetaTags>
          <title>Компани яааралтай</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Компани" breadcrumbItem="Компани яааралтай эрх" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
                                            ...
                                            <Col xs={12}>
                                              ...
                                              <div className="mb-3">
                                                ...
                                                <Input
                                                  ...
                                                  onBlur={validation.handleBlur}
                                                  value={
                                                    validation.values.urgent ||
                                                    undefined
                                                  }
                                                  invalid={
                                                    validation.touched.urgent &&
                                                    validation.errors.urgent
                                                      ? true
                                                      : false
                                                  }
                                                />
...
export default withRouter(CompanyUrgentController)
