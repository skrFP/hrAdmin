...
const CompanyActive = props => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      ...
      authentication: (contact && contact.authentication) || false,
    },
    ...
    },
    {
      ...
      formatter: (cellContent, company) => (
        <>
          <h5 className="font-size-14 mb-1">
            <Link to="#" className="text-dark">
              {company.authentication === false ? (
                <>
                  <h5 className="font-size-14 mb-1" style={{ color: "red" }}>
                    Идэвхгүй
                  </h5>
                </>
              ) : (
                <>
                  <h5 className="font-size-14 mb-1" style={{ color: "green" }}>
                    Идэвхтэй
                  </h5>
                </>
              )}
  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <MetaTags>
          <title>Компани идэвх</title>
        </MetaTags>
        <Container fluid>
          {/* Render Breadcrumbs */}
          <Breadcrumbs title="Компани" breadcrumbItem="Компани идэвх" />
          <Row>
            <Col lg="12">
              <Card>
                <CardBody>
